...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { uint8_T * o_o_B_24_2
= ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; ha1ipjbq54 ( o_o_B_24_2 ) ;
} static void mdlReset ( SimStruct * S ) { gwlyno50ln ( ) ; } static void
mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { const SensorsBus *
i_kbv1jfsawh = ( SensorsBus * ) ssGetInputPortSignal ( S , 1 ) ; real32_T *
o_B_24_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; uint8_T *
o_o_B_24_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 )
{ flightControlSystemTID0 ( i_kbv1jfsawh , o_B_24_1 , o_o_B_24_2 ) ;
...
void mdlOutputs ( SimStruct * S , int_T tid ) { const SensorsBus *
i_kbv1jfsawh = ( SensorsBus * ) ssGetInputPortSignal ( S , 1 ) ; real32_T *
o_B_24_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; uint8_T *
o_o_B_24_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { flightControlSystemTID2 ( ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) ) { flightControlSystemTID0 ( i_kbv1jfsawh , o_B_24_1 , o_o_B_24_2 ) ;

...
MODULES              = hough_d_rt.c hough_r_rt.c edgecanny_autoth_r_rt.c rc_gaussian_smoothing_r_rt.c r_derivative_image_r_rt.c c_derivative_image_r_rt.c nonmaximum_suppression_r_rt.c flightControlSystem.c flightControlSystem_capi.c flightControlSystem_data.c c_mexapi_version.c
PRODUCT              = flightControlSystemlib.lib
MAKEFILE             = flightControlSystem.mk
MATLAB_ROOT          = X:/X DRIVE/MATLAB
ALT_MATLAB_ROOT      = X:/XDRIVE~1/MATLAB
MATLAB_BIN           = X:/X DRIVE/MATLAB/bin
ALT_MATLAB_BIN       = X:/XDRIVE~1/MATLAB/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = X:/XDRIVE~1/Github/GODrones/work
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 0
...
ADD_INCLUDES = \
	...
	-I$(MATLAB_ROOT)/toolbox/vision/visionrt/export/include \
	-I$(MATLAB_ROOT)/toolbox/vision/visionrt/export/include/visionrt \
...
%.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
...
hough_d_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/viphough/hough_d_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/viphough/hough_d_rt.c

hough_r_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/viphough/hough_r_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/viphough/hough_r_rt.c

edgecanny_autoth_r_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/edgecanny_autoth_r_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/edgecanny_autoth_r_rt.c

rc_gaussian_smoothing_r_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/rc_gaussian_smoothing_r_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/rc_gaussian_smoothing_r_rt.c

r_derivative_image_r_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/r_derivative_image_r_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/r_derivative_image_r_rt.c

c_derivative_image_r_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/c_derivative_image_r_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/c_derivative_image_r_rt.c

nonmaximum_suppression_r_rt.obj : $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/nonmaximum_suppression_r_rt.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/vision/visionrt/vipedge/nonmaximum_suppression_r_rt.c
